...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('role:admin,manager,sales')
        ->prefix('customers')
        ->name('customers.')
        ->group(function () {
    ...
    Route::middleware('role:admin,manager')
        ...
        ->name('customers.')
        ->group(function () {
            Route::patch('/{customer}/reassign', [CustomerController::class, 'reassign'])
                ->whereNumber('customer')
                ->name('reassign');
            Route::patch('/{customer}/assignment/approve', [CustomerController::class, 'approveAssignment'])
                ->whereNumber('customer')
                ->name('assignment.approve');
            Route::patch('/{customer}/assignment/reject', [CustomerController::class, 'rejectAssignment'])
                ->whereNumber('customer')
