    ...
    <div class="container-fluid px-3 px-md-4 py-4">
        <div class="crm-page-header d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                ...
                <h1 class="h3 mb-1 fw-semibold">Edit Customer #{{ $customer->id }}</h1>
                <p class="text-muted mb-0 small">Update customer profile, contact information, and ownership details.</p>
            </div>
        ...
        <form method="POST" action="{{ route('customers.update', $customer) }}" class="crm-form-shell row g-4">
            @csrf
            @method('PUT')
                ...
                <div class="card border-0 shadow-sm crm-form-card mb-4">
                    <div class="card-body">
                        <div class="crm-form-section-head">
                            ...
                            <p class="crm-form-section-copy">Keep the customer profile accurate and easy for the team to review.</p>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="company" class="form-control @error('company') is-invalid @enderror" value="{{ old('company', $customer->company) }}">
                                @error('company') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-medium">Address</label>
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="4">{{ old('address', $customer->address) }}</textarea>
            ...
            <div class="col-12 col-xl-4">
                <div class="card border-0 shadow-sm crm-form-card mb-4">
                    <div class="card-body">
                        <div class="crm-form-section-head">
                            ...
                            <p class="crm-form-section-copy">Review status and confirm the assigned owner for this record.</p>
                        </div>
                ...
                <div class="crm-note-box mb-4">
                    Editing the assignee may trigger assignment review state changes based on the current CRM rules.
                </div>

                <div class="crm-form-actions">
                    <button type="submit" class="btn btn-success flex-grow-1">Update Customer</button>
