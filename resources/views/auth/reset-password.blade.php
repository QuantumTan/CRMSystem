...
<head>
    ...
    <title>Set New Password - {{ config('app.name', 'NexLink CRM') }}</title>
    ...
    <div class="container-fluid p-0 min-vh-100 d-flex align-items-center justify-content-center">
        <div class="card border shadow-sm rounded-4 w-100 mx-3" style="max-width: 480px;">
            <div class="card-body p-4 p-lg-5">
                ...
                <h2 class="fw-bold mb-2" style="letter-spacing:-.03em;color:var(--nx-navy);">Create a new password</h2>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    @csrf
                    {{-- token to verify you are the one changing it --}}
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" type="email" name="email"
                                ...
                                value="{{ old('email', $request->email) }}" placeholder="you@company.com" required autocomplete="email">
                        </div>
                        @error('email')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password" type="password" name="password"
                                class="form-control p-2 bg-light border-start-0 rounded-end-3 @error('password') is-invalid @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password_confirmation" type="password" name="password_confirmation"
                                class="form-control p-2 bg-light border-start-0 rounded-end-3"
                                placeholder="Confirm new password" required autocomplete="new-password">
                        </div>
                    </div>

                    <button type="submit" class="btn btn-nexlink w-100 py-2 fw-semibold rounded-3 mb-3">
                        <i class="bi bi-check2-circle me-2"></i>Reset password
                    </button>

                    <a href="{{ route('login') }}" class="btn btn-outline-secondary w-100 py-2 rounded-3">
                        Back to sign in
                    </a>
                </form>
            </div>
